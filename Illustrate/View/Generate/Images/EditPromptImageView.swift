...
struct EditPromptImageView: View {
    ...
    func getSupportedModels() -> [PartnerModel] {
        ...
        return partnerModels.filter({ $0.modelSetType == EnumSetType.EDIT_PROMPT && $0.partnerId.uuidString == selectedPartnerId })
    }
    ...
    var body: some View {
                        ...
                        Picker("Partner", selection: $selectedPartnerId) {
                            ForEach(
                                partners.filter { partner in
                                    ...
                                    partnerModels.contains { $0.partnerId == partner.partnerId && $0.modelSetType == .EDIT_PROMPT }
                                }, id: \.partnerId
                            ) { partner in
                                HStack {
                                    #if !os(macOS)
        ...
        .navigationTitle("Edit with Prompt")
    }
}
