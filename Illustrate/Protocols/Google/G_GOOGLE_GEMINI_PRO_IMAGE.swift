...
class G_GOOGLE_GEMINI_PRO_IMAGE: ImageGenerationProtocol {
    ...
    struct ServiceRequest: Codable {
        ...
        init(prompt: String, aspectRatio: String?, artQuality: EnumArtQuality, modalities: [String]?) {
            self.contents = [
    ...
    func transformRequest(request: ImageGenerationRequest) -> ServiceRequest {
        ...
        return ServiceRequest(prompt: request.prompt, aspectRatio: aspectRatio, artQuality: request.artQuality, modalities: modalities)
    }
