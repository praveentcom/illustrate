...
class G_REPLICATE_SEEDREAM_4_EDIT: ImageGenerationProtocol {
    ...
    struct ServiceRequest: Codable {
        ...
        init(prompt: String, imageInput: [String], aspectRatio: String = "match_input_image", size: String = "2K", enhancePrompt: Bool = true) {
            self.prompt = prompt
